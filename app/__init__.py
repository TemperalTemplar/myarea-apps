...
APPS = [
    ...
    {"id":"wger","name":"Wger","tagline":"Workout manager and fitness tracker.","url":"https://fitness.wrds361.com","icon":"bi-heart-pulse-fill","color":"#dc2626","category":"Wellness","native":False,"description":"Track workouts, nutrition, and body measurements. Build custom routines and log progress.","features":["Workout routines","Exercise library","Nutrition tracking","Progress charts"]},
